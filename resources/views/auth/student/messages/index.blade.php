...
@section('content')
    ...
    <div class="student-content-wrapper">
        <div class="header-row">
            <h2>Сообщения</h2>
            <a href="{{ route('student.messages.create') }}" class="btn-create">+ Новое сообщение</a>
        </div>
        ...
        <div class="filter-row">
            ...
            |
            <a href="{{ route('student.messages.index',['status'=>'pending']) }}"
               class="{{ $statusFilter==='pending' ? 'active' : '' }}">
                Ожидают ответа
            </a>
            |
            <a href="{{ route('student.messages.index',['status'=>'answered']) }}"
