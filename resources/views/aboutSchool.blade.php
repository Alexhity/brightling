        ...
        <div class="container1">
            ...
            <div class="content-full">
                ...
                <div class="faq-accordion">
                    ...
                    <div class="faq-item">
                        <button class="faq-question">
                            <span class="faq-title">Как узнать свой уровень языка?</span>
                            <span class="faq-icon">+</span>
                        </button>
                        <div class="faq-answer">
                            <p class="about-text">
                                Для того, чтобы вам узнать ваш уровень - нужно записаться на тестовый урок по желаемому времени, далее наши профессиональные учиетял за 15 минут выявят ваш уровень
                            </p>
                        </div>
                    </div>
                    {{-- Вопрос 4 --}}
